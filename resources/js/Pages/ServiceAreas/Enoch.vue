      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="bg-white rounded-2xl border border-stone-dark p-6">
            ...
            <p class="text-granite text-sm mb-4">Headstone styles we craft for Enoch families — verified against local cemetery rules before production. Tap any image to enlarge.</p>
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
              ...
              >
                <img :src="img" :alt="`Headstone and monument example for Enoch`" class="w-full h-full object-cover" />
              </button>
            </div>
          </div>
          <div class="bg-white rounded-2xl border border-stone-dark p-8">
